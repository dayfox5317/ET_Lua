        ...
        private IProtoSerializer BuildSerializer()
        {
            ...
            try
            {
                ...
                if (IsMap)
                {
                    ...
                    var mp = new MapDecorator1(model, concreteType, keySer, valueSer, fieldNumber, DataFormat == DataFormat.Group ? WireType.StartGroup : WireType.String, keyWireType, valueWireType, OverwriteList);
                    mp.TDictionary = dictionaryType;
                    mp.TKey = keyType;
                    mp.TValue = valueType;
                    ser = mp;
