...
#pragma warning restore 414
    ...
    public partial class ObjectTranslator
	{
        ...
        public bool TryDelayWrapLoader(RealStatePtr L, Type type)
        {
            ...
            else
            {
                ...
                if (!typeof(Delegate).IsAssignableFrom(type))
                {
                    ...
                    var  cfg = AutoGenMissingConfig.Load();

                    if(!cfg.types.Contains(type.FullName))
                    cfg.types.Add(type.FullName);
        ...
        {
            //fix 与csharp.lua配合反射
            Utils.BeginObjectRegister(null, L, this, 1, 2, 1, 0, common_array_meta);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "get", StaticLuaCallbacks.ArrayIndexer);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "set", StaticLuaCallbacks.ArrayNewIndexer);
