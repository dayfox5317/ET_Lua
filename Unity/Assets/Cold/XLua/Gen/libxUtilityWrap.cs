...
namespace XLua.CSObjectWrap
{
    ...
    public partial class libxUtilityWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(libx.Utility);
        ...
        {
            return LuaAPI.luaL_error(L, "libx.Utility does not have a constructor!");
        }
        ...
        static int _m_GetMD5Hash_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _input = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = libx.Utility.GetMD5Hash( 
                        _input );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to libx.Utility.GetMD5Hash!");
		    ...
		    try {
                ...
                
                {
                    ...
                    string _hash = LuaAPI.lua_tostring(L, 2);
                        ...
                        bool gen_ret = libx.Utility.VerifyMd5Hash( 
                        _input, 
                        _hash );
        ...
        static int _m_GetCRC32Hash_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<System.IO.Stream>(L, 1)) 
                {
                    System.IO.Stream _input = (System.IO.Stream)translator.GetObject(L, 1, typeof(System.IO.Stream));
                        ...
                        string gen_ret = libx.Utility.GetCRC32Hash( 
                        _input );
                        LuaAPI.lua_pushstring(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to libx.Utility.GetCRC32Hash!");
		    ...
		    try {
                ...
                
                {
                    byte[] _bytes = LuaAPI.lua_tobytes(L, 1);
                        ...
                        uint gen_ret = libx.Utility.GetCrc( 
                        _bytes );
		    ...
		    try {
                ...
                
                {
                    ...
                    string _hash = LuaAPI.lua_tostring(L, 2);
                        ...
                        bool gen_ret = libx.Utility.VerifyCrc32Hash( 
                        _input, 
                        _hash );
                        LuaAPI.lua_pushboolean(L, gen_ret);
