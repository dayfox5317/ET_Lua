...
namespace XLua.CSObjectWrap
{
    ...
    public partial class ETAsyncETTaskCompletedMethodBuilderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ET.AsyncETTaskCompletedMethodBuilder);
		...
		public static int __clone__(RealStatePtr L)
		{
			...
			{
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				ET.AsyncETTaskCompletedMethodBuilder gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(ET.AsyncETTaskCompletedMethodBuilder));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ET.AsyncETTaskCompletedMethodBuilder constructor!");
        ...
        static int _m_Create_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        ET.AsyncETTaskCompletedMethodBuilder gen_ret = ET.AsyncETTaskCompletedMethodBuilder.Create(  );
