...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIDefaultControlsResourcesWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstandard", _g_get_standard);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbackground", _g_get_background);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getinputField", _g_get_inputField);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getknob", _g_get_knob);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcheckmark", _g_get_checkmark);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setstandard", _s_set_standard);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbackground", _s_set_background);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setinputField", _s_set_inputField);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setknob", _s_set_knob);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcheckmark", _s_set_checkmark);
