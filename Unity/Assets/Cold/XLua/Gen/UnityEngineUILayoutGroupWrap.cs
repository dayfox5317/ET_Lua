...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUILayoutGroupWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.UI.LayoutGroup);
			Utils.BeginObjectRegister(type, L, translator, 0, 15, 9, 2);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpadding", _g_get_padding);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getchildAlignment", _g_get_childAlignment);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpadding", _s_set_padding);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setchildAlignment", _s_set_childAlignment);
