...
namespace XLua.CSObjectWrap
{
    ...
    public partial class ETColdILogWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ETCold.ILog);
        ...
        {
            return LuaAPI.luaL_error(L, "ETCold.ILog does not have a constructor!");
        }
        ...
        static int _m_Trace(RealStatePtr L)
        {
		    try {
                ...
                ETCold.ILog gen_to_be_invoked = (ETCold.ILog)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ETCold.ILog.Trace!");
        ...
        static int _m_Warning(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ETCold.ILog.Warning!");
        ...
        static int _m_Info(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ETCold.ILog.Info!");
        ...
        static int _m_Debug(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ETCold.ILog.Debug!");
        ...
        static int _m_Error(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ETCold.ILog.Error!");
