...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIAspectRatioFitterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getaspectMode", _g_get_aspectMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getaspectRatio", _g_get_aspectRatio);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setaspectMode", _s_set_aspectMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setaspectRatio", _s_set_aspectRatio);
