...
namespace XLua.CSObjectWrap
{
    ...
    public partial class BattlehubUIControlsCancelArgsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Battlehub.UIControls.CancelArgs);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Battlehub.UIControls.CancelArgs gen_ret = new Battlehub.UIControls.CancelArgs();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Battlehub.UIControls.CancelArgs constructor!");
        ...
        static int _g_get_Cancel(RealStatePtr L)
        {
		    try {
                ...
                Battlehub.UIControls.CancelArgs gen_to_be_invoked = (Battlehub.UIControls.CancelArgs)translator.FastGetCSObj(L, 1);
