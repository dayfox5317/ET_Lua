...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIVertexBufferWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.VertexBuffer);
			Utils.BeginObjectRegister(type, L, translator, 0, 25, 10, 4);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettextureSize", _g_get_textureSize);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuvs", _g_get_uvs);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuvs2", _g_get_uvs2);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settextureSize", _s_set_textureSize);
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 10, 2, 2);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "Begin", _m_Begin_xlua_st_);
            
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getNormalizedUV", _g_get_NormalizedUV);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getNormalizedPosition", _g_get_NormalizedPosition);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setNormalizedUV", _s_set_NormalizedUV);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setNormalizedPosition", _s_set_NormalizedPosition);
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _usePercent = LuaAPI.lua_toboolean(L, 3);
                        ...
                        UnityEngine.Vector2 gen_ret = gen_to_be_invoked.GetUVAtPosition( 
                        _position, 
                        _usePercent );
