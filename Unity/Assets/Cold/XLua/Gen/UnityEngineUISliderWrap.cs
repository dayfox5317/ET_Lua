...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUISliderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.UI.Slider);
			Utils.BeginObjectRegister(type, L, translator, 0, 31, 9, 9);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfillRect", _g_get_fillRect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethandleRect", _g_get_handleRect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdirection", _g_get_direction);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getminValue", _g_get_minValue);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmaxValue", _g_get_maxValue);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getwholeNumbers", _g_get_wholeNumbers);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getvalue", _g_get_value);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getnormalizedValue", _g_get_normalizedValue);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonValueChanged", _g_get_onValueChanged);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfillRect", _s_set_fillRect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethandleRect", _s_set_handleRect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdirection", _s_set_direction);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setminValue", _s_set_minValue);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmaxValue", _s_set_maxValue);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setwholeNumbers", _s_set_wholeNumbers);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setvalue", _s_set_value);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setnormalizedValue", _s_set_normalizedValue);
        ...
        static int _m_SetDirection(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetDirection( 
                        _direction, 
                        _includeRectLayouts );
