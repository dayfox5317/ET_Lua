...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIUIPackageWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetItemsArray", _m_GetItemsArray);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "AddPackageAsync", _m_AddPackageAsync_xlua_st_);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getbranch", _g_get_branch);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getunloadBundleByFGUI", _g_get_unloadBundleByFGUI);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setbranch", _s_set_branch);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setunloadBundleByFGUI", _s_set_unloadBundleByFGUI);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addonReleaseResource", _e_add_onReleaseResource);
			
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removeonReleaseResource", _e_remove_onReleaseResource);
		    ...
		    try {
                ...
                
                {
                    string _key = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = FairyGUI.UIPackage.GetVar( 
                        _key );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AddPackageAsync_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    FairyGUI.UIPackage.LoadResourceAsync _loadFunc = translator.GetDelegate<FairyGUI.UIPackage.LoadResourceAsync>(L, 3);
                        ...
                        FairyGUI.UIPackage gen_ret = FairyGUI.UIPackage.AddPackageAsync( 
                        _descData, 
                        _assetNamePrefix, 
                        _loadFunc );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetItemsArray(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        FairyGUI.PackageItem[] gen_ret = gen_to_be_invoked.GetItemsArray(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SetItemAsset(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetItemAsset( 
                        _item, 
                        _asset, 
                        _destroyMethod );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_onReleaseResource(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                System.Action<FairyGUI.PackageItem> gen_delegate = translator.GetDelegate<System.Action<FairyGUI.PackageItem>>(L, 1);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#1 need System.Action<FairyGUI.PackageItem>!");
                }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_onReleaseResource(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
