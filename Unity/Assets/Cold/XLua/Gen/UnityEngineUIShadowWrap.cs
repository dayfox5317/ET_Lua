...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIShadowWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "geteffectColor", _g_get_effectColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "geteffectDistance", _g_get_effectDistance);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuseGraphicAlpha", _g_get_useGraphicAlpha);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "seteffectColor", _s_set_effectColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "seteffectDistance", _s_set_effectDistance);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setuseGraphicAlpha", _s_set_useGraphicAlpha);
