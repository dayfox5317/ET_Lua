...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineLayerMaskWrap 
    {
        ...
        {					
			...
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
                UnityEngine.LayerMask rightside;translator.Get(L, 1, out rightside);
		    ...
		    try {
                ...
                
                {
                    int _layer = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        string gen_ret = UnityEngine.LayerMask.LayerToName( 
                        _layer );
		    ...
		    try {
                ...
                
                {
                    string _layerName = LuaAPI.lua_tostring(L, 1);
                        ...
                        int gen_ret = UnityEngine.LayerMask.NameToLayer( 
                        _layerName );
		    ...
		    try {
                ...
                
                {
                    string[] _layerNames = translator.GetParams<string>(L, 1);
                        ...
                        int gen_ret = UnityEngine.LayerMask.GetMask( 
                        _layerNames );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
