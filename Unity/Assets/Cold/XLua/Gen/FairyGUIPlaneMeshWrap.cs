...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIPlaneMeshWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getgridSize", _g_get_gridSize);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setgridSize", _s_set_gridSize);
