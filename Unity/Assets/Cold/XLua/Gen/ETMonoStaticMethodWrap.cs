...
namespace XLua.CSObjectWrap
{
    ...
    public partial class ETMonoStaticMethodWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ET.MonoStaticMethod);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.Type>(L, 2) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING))
				{
					...
					ET.MonoStaticMethod gen_ret = new ET.MonoStaticMethod(_type, _methodName);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ET.MonoStaticMethod constructor!");
        ...
        static int _m_Run(RealStatePtr L)
        {
		    try {
                ...
                ET.MonoStaticMethod gen_to_be_invoked = (ET.MonoStaticMethod)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ET.MonoStaticMethod.Run!");
