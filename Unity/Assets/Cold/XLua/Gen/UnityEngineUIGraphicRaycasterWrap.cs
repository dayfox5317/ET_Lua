...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIGraphicRaycasterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsortOrderPriority", _g_get_sortOrderPriority);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrenderOrderPriority", _g_get_renderOrderPriority);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getignoreReversedGraphics", _g_get_ignoreReversedGraphics);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getblockingObjects", _g_get_blockingObjects);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getblockingMask", _g_get_blockingMask);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "geteventCamera", _g_get_eventCamera);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setignoreReversedGraphics", _s_set_ignoreReversedGraphics);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setblockingObjects", _s_set_blockingObjects);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setblockingMask", _s_set_blockingMask);
