...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIDynamicFontWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getnativeFont", _g_get_nativeFont);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setnativeFont", _s_set_nativeFont);
