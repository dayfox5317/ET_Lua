...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIMaskableGraphicWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonCullStateChanged", _g_get_onCullStateChanged);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmaskable", _g_get_maskable);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisMaskingGraphic", _g_get_isMaskingGraphic);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setonCullStateChanged", _s_set_onCullStateChanged);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmaskable", _s_set_maskable);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setisMaskingGraphic", _s_set_isMaskingGraphic);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Material _baseMaterial = (UnityEngine.Material)translator.GetObject(L, 2, typeof(UnityEngine.Material));
                        ...
                        UnityEngine.Material gen_ret = gen_to_be_invoked.GetModifiedMaterial( 
                        _baseMaterial );
