...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIGoWrapperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.GoWrapper);
			Utils.BeginObjectRegister(type, L, translator, 0, 15, 4, 4);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcustomCloneMaterials", _g_get_customCloneMaterials);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcustomRecoverMaterials", _g_get_customRecoverMaterials);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcustomCloneMaterials", _s_set_customCloneMaterials);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcustomRecoverMaterials", _s_set_customRecoverMaterials);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "addonUpdate", _e_add_onUpdate);
						
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "removeonUpdate", _e_remove_onUpdate);
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		static int _e_add_onUpdate(RealStatePtr L)
		{
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				int gen_param_count = LuaAPI.lua_gettop(L);
			FairyGUI.GoWrapper gen_to_be_invoked = (FairyGUI.GoWrapper)translator.FastGetCSObj(L, 1);
				System.Action<FairyGUI.UpdateContext> gen_delegate = translator.GetDelegate<System.Action<FairyGUI.UpdateContext>>(L, 2);
				if (gen_delegate == null) {
					return LuaAPI.luaL_error(L, "#2 need System.Action<FairyGUI.UpdateContext>!");
				}
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		static int _e_remove_onUpdate(RealStatePtr L)
		{
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				int gen_param_count = LuaAPI.lua_gettop(L);
