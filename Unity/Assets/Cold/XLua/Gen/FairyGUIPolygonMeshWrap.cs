...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIPolygonMeshWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.PolygonMesh);
			Utils.BeginObjectRegister(type, L, translator, 0, 15, 7, 5);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettexcoords", _g_get_texcoords);
