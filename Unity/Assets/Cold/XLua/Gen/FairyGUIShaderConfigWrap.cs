...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIShaderConfigWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 78, 19, 19);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getTMPFontShader", _g_get_TMPFontShader);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getID_ClipBox", _g_get_ID_ClipBox);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getID_ClipSoftness", _g_get_ID_ClipSoftness);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getID_AlphaTex", _g_get_ID_AlphaTex);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getID_StencilComp", _g_get_ID_StencilComp);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getID_Stencil", _g_get_ID_Stencil);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getID_StencilOp", _g_get_ID_StencilOp);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getID_StencilReadMask", _g_get_ID_StencilReadMask);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getID_ColorMask", _g_get_ID_ColorMask);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getID_ColorMatrix", _g_get_ID_ColorMatrix);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getID_ColorOffset", _g_get_ID_ColorOffset);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getID_BlendSrcFactor", _g_get_ID_BlendSrcFactor);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getID_BlendDstFactor", _g_get_ID_BlendDstFactor);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getID_ColorOption", _g_get_ID_ColorOption);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getID_Stencil2", _g_get_ID_Stencil2);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setTMPFontShader", _s_set_TMPFontShader);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setID_ClipBox", _s_set_ID_ClipBox);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setID_ClipSoftness", _s_set_ID_ClipSoftness);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setID_AlphaTex", _s_set_ID_AlphaTex);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setID_StencilComp", _s_set_ID_StencilComp);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setID_Stencil", _s_set_ID_Stencil);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setID_StencilOp", _s_set_ID_StencilOp);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setID_StencilReadMask", _s_set_ID_StencilReadMask);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setID_ColorMask", _s_set_ID_ColorMask);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setID_ColorMatrix", _s_set_ID_ColorMatrix);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setID_ColorOffset", _s_set_ID_ColorOffset);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setID_BlendSrcFactor", _s_set_ID_BlendSrcFactor);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setID_BlendDstFactor", _s_set_ID_BlendDstFactor);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setID_ColorOption", _s_set_ID_ColorOption);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setID_Stencil2", _s_set_ID_Stencil2);
