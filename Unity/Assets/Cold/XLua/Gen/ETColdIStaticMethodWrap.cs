...
namespace XLua.CSObjectWrap
{
    ...
    public partial class ETColdIStaticMethodWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ETCold.IStaticMethod);
        ...
        {
            return LuaAPI.luaL_error(L, "ETCold.IStaticMethod does not have a constructor!");
        }
        ...
        static int _m_Run(RealStatePtr L)
        {
		    try {
                ...
                ETCold.IStaticMethod gen_to_be_invoked = (ETCold.IStaticMethod)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ETCold.IStaticMethod.Run!");
