...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineTimeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 63, 25, 6);
			
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "gettime", _g_get_time);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettimeAsDouble", _g_get_timeAsDouble);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettimeSinceLevelLoad", _g_get_timeSinceLevelLoad);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettimeSinceLevelLoadAsDouble", _g_get_timeSinceLevelLoadAsDouble);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getfixedTimeAsDouble", _g_get_fixedTimeAsDouble);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getunscaledTime", _g_get_unscaledTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getunscaledTimeAsDouble", _g_get_unscaledTimeAsDouble);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getfixedUnscaledTime", _g_get_fixedUnscaledTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getfixedUnscaledTimeAsDouble", _g_get_fixedUnscaledTimeAsDouble);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getrealtimeSinceStartupAsDouble", _g_get_realtimeSinceStartupAsDouble);
