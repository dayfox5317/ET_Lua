...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineEventSystemsEventTriggerEntryWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "geteventID", _g_get_eventID);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcallback", _g_get_callback);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "seteventID", _s_set_eventID);
