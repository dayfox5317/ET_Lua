...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIUpdateContextClipInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.UpdateContext.ClipInfo);
			Utils.BeginObjectRegister(type, L, translator, 0, 17, 8, 8);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getreferenceValue", _g_get_referenceValue);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getreversed", _g_get_reversed);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setreferenceValue", _s_set_referenceValue);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setreversed", _s_set_reversed);
