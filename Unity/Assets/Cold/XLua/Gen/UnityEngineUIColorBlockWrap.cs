...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIColorBlockWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.UI.ColorBlock);
			Utils.BeginObjectRegister(type, L, translator, 1, 17, 7, 7);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethighlightedColor", _g_get_highlightedColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpressedColor", _g_get_pressedColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectedColor", _g_get_selectedColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdisabledColor", _g_get_disabledColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcolorMultiplier", _g_get_colorMultiplier);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfadeDuration", _g_get_fadeDuration);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setnormalColor", _s_set_normalColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethighlightedColor", _s_set_highlightedColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpressedColor", _s_set_pressedColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectedColor", _s_set_selectedColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdisabledColor", _s_set_disabledColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcolorMultiplier", _s_set_colorMultiplier);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfadeDuration", _s_set_fadeDuration);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getdefaultColorBlock", _g_get_defaultColorBlock);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setdefaultColorBlock", _s_set_defaultColorBlock);
