...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIGRootWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.GRoot);
			Utils.BeginObjectRegister(type, L, translator, 0, 32, 7, 2);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcontentScaleLevel", _g_get_contentScaleLevel);
