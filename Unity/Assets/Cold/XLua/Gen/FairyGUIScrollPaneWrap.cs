...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIScrollPaneWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.ScrollPane);
			Utils.BeginObjectRegister(type, L, translator, 0, 72, 34, 18);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisDragged", _g_get_isDragged);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getTWEEN_TIME_GO", _g_get_TWEEN_TIME_GO);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getTWEEN_TIME_DEFAULT", _g_get_TWEEN_TIME_DEFAULT);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getPULL_RATIO", _g_get_PULL_RATIO);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setTWEEN_TIME_GO", _s_set_TWEEN_TIME_GO);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setTWEEN_TIME_DEFAULT", _s_set_TWEEN_TIME_DEFAULT);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setPULL_RATIO", _s_set_PULL_RATIO);
