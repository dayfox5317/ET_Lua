...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineRaycastHitWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.RaycastHit);
			Utils.BeginObjectRegister(type, L, translator, 0, 17, 12, 4);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getarticulationBody", _g_get_articulationBody);
