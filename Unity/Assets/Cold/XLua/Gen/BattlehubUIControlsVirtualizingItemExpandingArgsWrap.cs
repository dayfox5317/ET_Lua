...
namespace XLua.CSObjectWrap
{
    ...
    public partial class BattlehubUIControlsVirtualizingItemExpandingArgsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Battlehub.UIControls.VirtualizingItemExpandingArgs);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<object>(L, 2))
				{
					...
					Battlehub.UIControls.VirtualizingItemExpandingArgs gen_ret = new Battlehub.UIControls.VirtualizingItemExpandingArgs(_item);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Battlehub.UIControls.VirtualizingItemExpandingArgs constructor!");
        ...
        static int _g_get_Children(RealStatePtr L)
        {
		    try {
                ...
                Battlehub.UIControls.VirtualizingItemExpandingArgs gen_to_be_invoked = (Battlehub.UIControls.VirtualizingItemExpandingArgs)translator.FastGetCSObj(L, 1);
