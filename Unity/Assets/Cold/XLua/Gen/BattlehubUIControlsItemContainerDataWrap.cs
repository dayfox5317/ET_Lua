...
namespace XLua.CSObjectWrap
{
    ...
    public partial class BattlehubUIControlsItemContainerDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Battlehub.UIControls.ItemContainerData);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Battlehub.UIControls.ItemContainerData gen_ret = new Battlehub.UIControls.ItemContainerData();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Battlehub.UIControls.ItemContainerData constructor!");
        ...
        static int _g_get_IsSelected(RealStatePtr L)
        {
		    try {
                ...
                Battlehub.UIControls.ItemContainerData gen_to_be_invoked = (Battlehub.UIControls.ItemContainerData)translator.FastGetCSObj(L, 1);
