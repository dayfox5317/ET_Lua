...
namespace XLua.CSObjectWrap
{
    ...
    public partial class ETIAsyncStateMachineClassInheritanceAdaptorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ET.IAsyncStateMachineClassInheritanceAdaptor);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					ET.IAsyncStateMachineClassInheritanceAdaptor gen_ret = new ET.IAsyncStateMachineClassInheritanceAdaptor();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ET.IAsyncStateMachineClassInheritanceAdaptor constructor!");
        ...
        static int _m_CreateCLRInstance(RealStatePtr L)
        {
		    try {
                ...
                ET.IAsyncStateMachineClassInheritanceAdaptor gen_to_be_invoked = (ET.IAsyncStateMachineClassInheritanceAdaptor)translator.FastGetCSObj(L, 1);
