...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUITextFormatWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.TextFormat);
			Utils.BeginObjectRegister(type, L, translator, 0, 36, 16, 16);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstrikethrough", _g_get_strikethrough);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getoutline", _g_get_outline);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getoutlineColor", _g_get_outlineColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshadowOffset", _g_get_shadowOffset);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshadowColor", _g_get_shadowColor);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setstrikethrough", _s_set_strikethrough);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setoutline", _s_set_outline);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setoutlineColor", _s_set_outlineColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshadowOffset", _s_set_shadowOffset);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshadowColor", _s_set_shadowColor);
        ...
        static int _m_FillVertexColors(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.FillVertexColors( 
                        _vertexColors );
