...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineResourcesWrap 
    {
		    ...
		    try {
                ...
                
                {
                    int _instanceID = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        UnityEngine.Object gen_ret = UnityEngine.Resources.InstanceIDToObject( 
                        _instanceID );
                        translator.Push(L, gen_ret);
        ...
        static int _m_InstanceIDToObjectList_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Resources.InstanceIDToObjectList( 
                        _instanceIDs, 
                        _objects );
