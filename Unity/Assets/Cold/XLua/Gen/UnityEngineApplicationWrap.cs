...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineApplicationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 107, 30, 3);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getisPlaying", _g_get_isPlaying);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getisFocused", _g_get_isFocused);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getbuildGUID", _g_get_buildGUID);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getrunInBackground", _g_get_runInBackground);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getisBatchMode", _g_get_isBatchMode);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getdataPath", _g_get_dataPath);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getstreamingAssetsPath", _g_get_streamingAssetsPath);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getpersistentDataPath", _g_get_persistentDataPath);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettemporaryCachePath", _g_get_temporaryCachePath);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getabsoluteURL", _g_get_absoluteURL);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getunityVersion", _g_get_unityVersion);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getversion", _g_get_version);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getinstallerName", _g_get_installerName);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getidentifier", _g_get_identifier);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getinstallMode", _g_get_installMode);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getsandboxType", _g_get_sandboxType);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getproductName", _g_get_productName);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcompanyName", _g_get_companyName);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcloudProjectId", _g_get_cloudProjectId);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettargetFrameRate", _g_get_targetFrameRate);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getconsoleLogPath", _g_get_consoleLogPath);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getbackgroundLoadingPriority", _g_get_backgroundLoadingPriority);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getgenuine", _g_get_genuine);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getgenuineCheckAvailable", _g_get_genuineCheckAvailable);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getplatform", _g_get_platform);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getisMobilePlatform", _g_get_isMobilePlatform);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getisConsolePlatform", _g_get_isConsolePlatform);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getsystemLanguage", _g_get_systemLanguage);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getinternetReachability", _g_get_internetReachability);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getisEditor", _g_get_isEditor);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setrunInBackground", _s_set_runInBackground);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "settargetFrameRate", _s_set_targetFrameRate);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setbackgroundLoadingPriority", _s_set_backgroundLoadingPriority);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addlowMemory", _e_add_lowMemory);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addlogMessageReceived", _e_add_logMessageReceived);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addlogMessageReceivedThreaded", _e_add_logMessageReceivedThreaded);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addonBeforeRender", _e_add_onBeforeRender);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addfocusChanged", _e_add_focusChanged);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "adddeepLinkActivated", _e_add_deepLinkActivated);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addwantsToQuit", _e_add_wantsToQuit);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addquitting", _e_add_quitting);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addunloading", _e_add_unloading);
			
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removelowMemory", _e_remove_lowMemory);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removelogMessageReceived", _e_remove_logMessageReceived);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removelogMessageReceivedThreaded", _e_remove_logMessageReceivedThreaded);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removeonBeforeRender", _e_remove_onBeforeRender);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removefocusChanged", _e_remove_focusChanged);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removedeepLinkActivated", _e_remove_deepLinkActivated);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removewantsToQuit", _e_remove_wantsToQuit);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removequitting", _e_remove_quitting);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removeunloading", _e_remove_unloading);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)) 
                {
                    int _levelIndex = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        bool gen_ret = UnityEngine.Application.CanStreamedLevelBeLoaded( 
                        _levelIndex );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Object _obj = (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                        ...
                        bool gen_ret = UnityEngine.Application.IsPlaying( 
                        _obj );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        static int _m_SetBuildTags_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Application.SetBuildTags( 
                        _buildTags );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Application.AdvertisingIdentifierCallback _delegateMethod = translator.GetDelegate<UnityEngine.Application.AdvertisingIdentifierCallback>(L, 1);
                        ...
                        bool gen_ret = UnityEngine.Application.RequestAdvertisingIdentifierAsync( 
                        _delegateMethod );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.LogType _logType;translator.Get(L, 1, out _logType);
                        ...
                        UnityEngine.StackTraceLogType gen_ret = UnityEngine.Application.GetStackTraceLogType( 
                        _logType );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.UserAuthorization _mode;translator.Get(L, 1, out _mode);
                        ...
                        UnityEngine.AsyncOperation gen_ret = UnityEngine.Application.RequestUserAuthorization( 
                        _mode );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.UserAuthorization _mode;translator.Get(L, 1, out _mode);
                        ...
                        bool gen_ret = UnityEngine.Application.HasUserAuthorization( 
                        _mode );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_lowMemory(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                UnityEngine.Application.LowMemoryCallback gen_delegate = translator.GetDelegate<UnityEngine.Application.LowMemoryCallback>(L, 1);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#1 need UnityEngine.Application.LowMemoryCallback!");
                }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_logMessageReceived(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                UnityEngine.Application.LogCallback gen_delegate = translator.GetDelegate<UnityEngine.Application.LogCallback>(L, 1);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#1 need UnityEngine.Application.LogCallback!");
                }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_logMessageReceivedThreaded(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_onBeforeRender(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                UnityEngine.Events.UnityAction gen_delegate = translator.GetDelegate<UnityEngine.Events.UnityAction>(L, 1);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#1 need UnityEngine.Events.UnityAction!");
                }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_focusChanged(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                System.Action<bool> gen_delegate = translator.GetDelegate<System.Action<bool>>(L, 1);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#1 need System.Action<bool>!");
                }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_deepLinkActivated(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                System.Action<string> gen_delegate = translator.GetDelegate<System.Action<string>>(L, 1);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#1 need System.Action<string>!");
                }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_wantsToQuit(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                System.Func<bool> gen_delegate = translator.GetDelegate<System.Func<bool>>(L, 1);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#1 need System.Func<bool>!");
                }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_quitting(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                System.Action gen_delegate = translator.GetDelegate<System.Action>(L, 1);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#1 need System.Action!");
                }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_unloading(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_lowMemory(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_logMessageReceived(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_logMessageReceivedThreaded(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_onBeforeRender(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_focusChanged(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_deepLinkActivated(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_wantsToQuit(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_quitting(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_unloading(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
