...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineLightWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.Light);
			Utils.BeginObjectRegister(type, L, translator, 0, 70, 32, 31);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuseViewFrustumForShadowCasterCull", _g_get_useViewFrustumForShadowCasterCull);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setuseViewFrustumForShadowCasterCull", _s_set_useViewFrustumForShadowCasterCull);
