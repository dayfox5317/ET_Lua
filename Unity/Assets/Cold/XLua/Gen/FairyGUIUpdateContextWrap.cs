...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIUpdateContextWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.UpdateContext);
			Utils.BeginObjectRegister(type, L, translator, 0, 26, 9, 9);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstencilCompareValue", _g_get_stencilCompareValue);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setstencilCompareValue", _s_set_stencilCompareValue);
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 15, 2, 2);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addOnBegin", _e_add_OnBegin);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addOnEnd", _e_add_OnEnd);
			
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removeOnBegin", _e_remove_OnBegin);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removeOnEnd", _e_remove_OnEnd);
        ...
        static int _m_ApplyClippingProperties(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ApplyClippingProperties( 
                        _mat, 
                        _isStdMaterial );
        ...
        static int _m_ApplyAlphaMaskProperties(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ApplyAlphaMaskProperties( 
                        _mat, 
                        _erasing );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_OnBegin(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_OnEnd(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_OnBegin(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_OnEnd(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
