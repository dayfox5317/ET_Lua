...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineEventSystemsAxisEventDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmoveVector", _g_get_moveVector);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmoveDir", _g_get_moveDir);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmoveVector", _s_set_moveVector);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmoveDir", _s_set_moveDir);
