...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIGListWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.GList);
			Utils.BeginObjectRegister(type, L, translator, 0, 71, 23, 18);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdefaultItemSize", _g_get_defaultItemSize);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdefaultItemSize", _s_set_defaultItemSize);
        ...
        static int _m_EnableSelectionFocusEvents(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.EnableSelectionFocusEvents( 
                        _enabled );
        ...
        static int _m_EnableArrowKeyNavigation(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.EnableArrowKeyNavigation( 
                        _enabled );
		    ...
		    try {
                ...
                
                {
                    int _dir = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        int gen_ret = gen_to_be_invoked.HandleArrowKey( 
                        _dir );
