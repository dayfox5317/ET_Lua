...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIUtilsXMLWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.Utils.XML);
			Utils.BeginObjectRegister(type, L, translator, 0, 25, 4, 2);
		    ...
		    try {
                ...
                
                {
                    string _tag = LuaAPI.lua_tostring(L, 1);
                        ...
                        FairyGUI.Utils.XML gen_ret = FairyGUI.Utils.XML.Create( 
                        _tag );
                        translator.Push(L, gen_ret);
        ...
        static int _m_RemoveAttribute(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RemoveAttribute( 
                        _attrName );
		    ...
		    try {
                ...
                
                {
                    bool _includeHeader = LuaAPI.lua_toboolean(L, 2);
                        ...
                        string gen_ret = gen_to_be_invoked.ToXMLString( 
                        _includeHeader );
                        LuaAPI.lua_pushstring(L, gen_ret);
