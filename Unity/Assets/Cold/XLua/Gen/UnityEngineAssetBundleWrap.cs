...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineAssetBundleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisStreamedSceneAssetBundle", _g_get_isStreamedSceneAssetBundle);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    byte[] _binary = LuaAPI.lua_tobytes(L, 1);
                        ...
                        UnityEngine.AssetBundleCreateRequest gen_ret = UnityEngine.AssetBundle.LoadFromMemoryAsync( 
                        _binary );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<System.IO.Stream>(L, 1)) 
                {
                    System.IO.Stream _stream = (System.IO.Stream)translator.GetObject(L, 1, typeof(System.IO.Stream));
                        ...
                        UnityEngine.AssetBundle gen_ret = UnityEngine.AssetBundle.LoadFromStream( 
                        _stream );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.AssetBundleRequest gen_ret = gen_to_be_invoked.LoadAssetAsync( 
                        _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.Object[] gen_ret = gen_to_be_invoked.LoadAssetWithSubAssets( 
                        _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.AssetBundleRequest gen_ret = gen_to_be_invoked.LoadAssetWithSubAssetsAsync( 
                        _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 5&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.BuildCompression>(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& translator.Assignable<UnityEngine.ThreadPriority>(L, 5)) 
                {
                    ...
                    UnityEngine.ThreadPriority _priority;translator.Get(L, 5, out _priority);
                        ...
                        UnityEngine.AssetBundleRecompressOperation gen_ret = UnityEngine.AssetBundle.RecompressAssetBundleAsync( 
                        _inputPath, 
                        _outputPath, 
                        _method, 
                        _expectedCRC, 
