...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineRectTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getanchorMax", _g_get_anchorMax);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getanchoredPosition", _g_get_anchoredPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsizeDelta", _g_get_sizeDelta);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpivot", _g_get_pivot);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getanchoredPosition3D", _g_get_anchoredPosition3D);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getoffsetMin", _g_get_offsetMin);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getoffsetMax", _g_get_offsetMax);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setanchorMin", _s_set_anchorMin);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setanchorMax", _s_set_anchorMax);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setanchoredPosition", _s_set_anchoredPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsizeDelta", _s_set_sizeDelta);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpivot", _s_set_pivot);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setanchoredPosition3D", _s_set_anchoredPosition3D);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setoffsetMin", _s_set_offsetMin);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setoffsetMax", _s_set_offsetMax);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addreapplyDrivenProperties", _e_add_reapplyDrivenProperties);
			
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removereapplyDrivenProperties", _e_remove_reapplyDrivenProperties);
        ...
        static int _m_GetLocalCorners(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.GetLocalCorners( 
                        _fourCornersArray );
        ...
        static int _m_GetWorldCorners(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.GetWorldCorners( 
                        _fourCornersArray );
        ...
        static int _m_SetInsetAndSizeFromParentEdge(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetInsetAndSizeFromParentEdge( 
                        _edge, 
                        _inset, 
                        _size );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_reapplyDrivenProperties(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                UnityEngine.RectTransform.ReapplyDrivenProperties gen_delegate = translator.GetDelegate<UnityEngine.RectTransform.ReapplyDrivenProperties>(L, 1);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#1 need UnityEngine.RectTransform.ReapplyDrivenProperties!");
                }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_reapplyDrivenProperties(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
