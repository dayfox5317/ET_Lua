...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineEventSystemsPointerEventDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.EventSystems.PointerEventData);
			Utils.BeginObjectRegister(type, L, translator, 0, 44, 22, 19);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpointerEnter", _g_get_pointerEnter);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlastPress", _g_get_lastPress);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrawPointerPress", _g_get_rawPointerPress);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpointerDrag", _g_get_pointerDrag);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpointerClick", _g_get_pointerClick);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpointerCurrentRaycast", _g_get_pointerCurrentRaycast);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpointerPressRaycast", _g_get_pointerPressRaycast);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "geteligibleForClick", _g_get_eligibleForClick);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpointerId", _g_get_pointerId);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpressPosition", _g_get_pressPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getclickTime", _g_get_clickTime);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getclickCount", _g_get_clickCount);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscrollDelta", _g_get_scrollDelta);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuseDragThreshold", _g_get_useDragThreshold);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getenterEventCamera", _g_get_enterEventCamera);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpressEventCamera", _g_get_pressEventCamera);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpointerPress", _g_get_pointerPress);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethovered", _g_get_hovered);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpointerEnter", _s_set_pointerEnter);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrawPointerPress", _s_set_rawPointerPress);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpointerDrag", _s_set_pointerDrag);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpointerClick", _s_set_pointerClick);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpointerCurrentRaycast", _s_set_pointerCurrentRaycast);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpointerPressRaycast", _s_set_pointerPressRaycast);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "seteligibleForClick", _s_set_eligibleForClick);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpointerId", _s_set_pointerId);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpressPosition", _s_set_pressPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setclickTime", _s_set_clickTime);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setclickCount", _s_set_clickCount);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setscrollDelta", _s_set_scrollDelta);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setuseDragThreshold", _s_set_useDragThreshold);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdragging", _s_set_dragging);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbutton", _s_set_button);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpointerPress", _s_set_pointerPress);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethovered", _s_set_hovered);
