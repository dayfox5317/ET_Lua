...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIContentSizeFitterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethorizontalFit", _g_get_horizontalFit);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getverticalFit", _g_get_verticalFit);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethorizontalFit", _s_set_horizontalFit);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setverticalFit", _s_set_verticalFit);
