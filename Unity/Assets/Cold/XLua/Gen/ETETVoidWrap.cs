...
namespace XLua.CSObjectWrap
{
    ...
    public partial class ETETVoidWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ET.ETVoid);
		...
		public static int __clone__(RealStatePtr L)
		{
			...
			{
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				ET.ETVoid gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(ET.ETVoid));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ET.ETVoid constructor!");
