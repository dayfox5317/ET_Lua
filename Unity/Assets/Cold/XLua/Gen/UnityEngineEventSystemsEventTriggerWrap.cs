...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineEventSystemsEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettriggers", _g_get_triggers);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "settriggers", _s_set_triggers);
