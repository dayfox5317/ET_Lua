...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUINavigationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getwrapAround", _g_get_wrapAround);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectOnUp", _g_get_selectOnUp);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectOnDown", _g_get_selectOnDown);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectOnLeft", _g_get_selectOnLeft);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectOnRight", _g_get_selectOnRight);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmode", _s_set_mode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setwrapAround", _s_set_wrapAround);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectOnUp", _s_set_selectOnUp);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectOnDown", _s_set_selectOnDown);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectOnLeft", _s_set_selectOnLeft);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectOnRight", _s_set_selectOnRight);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getdefaultNavigation", _g_get_defaultNavigation);
