...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUISpriteStateWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethighlightedSprite", _g_get_highlightedSprite);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpressedSprite", _g_get_pressedSprite);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectedSprite", _g_get_selectedSprite);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdisabledSprite", _g_get_disabledSprite);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethighlightedSprite", _s_set_highlightedSprite);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpressedSprite", _s_set_pressedSprite);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectedSprite", _s_set_selectedSprite);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdisabledSprite", _s_set_disabledSprite);
