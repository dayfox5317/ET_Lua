...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineEventSystemsEventSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsendNavigationEvents", _g_get_sendNavigationEvents);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpixelDragThreshold", _g_get_pixelDragThreshold);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcurrentInputModule", _g_get_currentInputModule);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfirstSelectedGameObject", _g_get_firstSelectedGameObject);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcurrentSelectedGameObject", _g_get_currentSelectedGameObject);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisFocused", _g_get_isFocused);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getalreadySelecting", _g_get_alreadySelecting);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsendNavigationEvents", _s_set_sendNavigationEvents);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpixelDragThreshold", _s_set_pixelDragThreshold);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfirstSelectedGameObject", _s_set_firstSelectedGameObject);
        ...
        static int _m_SetSelectedGameObject(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.GameObject>(L, 2)) 
                {
                    ...
                    gen_to_be_invoked.SetSelectedGameObject( 
                        _selected );
