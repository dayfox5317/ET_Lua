...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIScrollRectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.UI.ScrollRect);
			Utils.BeginObjectRegister(type, L, translator, 0, 61, 27, 20);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethorizontal", _g_get_horizontal);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getvertical", _g_get_vertical);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmovementType", _g_get_movementType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getelasticity", _g_get_elasticity);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getinertia", _g_get_inertia);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdecelerationRate", _g_get_decelerationRate);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscrollSensitivity", _g_get_scrollSensitivity);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getviewport", _g_get_viewport);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethorizontalScrollbar", _g_get_horizontalScrollbar);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getverticalScrollbar", _g_get_verticalScrollbar);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethorizontalScrollbarVisibility", _g_get_horizontalScrollbarVisibility);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getverticalScrollbarVisibility", _g_get_verticalScrollbarVisibility);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethorizontalScrollbarSpacing", _g_get_horizontalScrollbarSpacing);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getverticalScrollbarSpacing", _g_get_verticalScrollbarSpacing);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getnormalizedPosition", _g_get_normalizedPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethorizontalNormalizedPosition", _g_get_horizontalNormalizedPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getverticalNormalizedPosition", _g_get_verticalNormalizedPosition);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethorizontal", _s_set_horizontal);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setvertical", _s_set_vertical);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmovementType", _s_set_movementType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setelasticity", _s_set_elasticity);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setinertia", _s_set_inertia);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdecelerationRate", _s_set_decelerationRate);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setscrollSensitivity", _s_set_scrollSensitivity);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setviewport", _s_set_viewport);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethorizontalScrollbar", _s_set_horizontalScrollbar);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setverticalScrollbar", _s_set_verticalScrollbar);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethorizontalScrollbarVisibility", _s_set_horizontalScrollbarVisibility);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setverticalScrollbarVisibility", _s_set_verticalScrollbarVisibility);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethorizontalScrollbarSpacing", _s_set_horizontalScrollbarSpacing);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setverticalScrollbarSpacing", _s_set_verticalScrollbarSpacing);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setnormalizedPosition", _s_set_normalizedPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethorizontalNormalizedPosition", _s_set_horizontalNormalizedPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setverticalNormalizedPosition", _s_set_verticalNormalizedPosition);
