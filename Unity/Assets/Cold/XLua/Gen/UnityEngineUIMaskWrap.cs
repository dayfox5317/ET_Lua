...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIMaskWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshowMaskGraphic", _g_get_showMaskGraphic);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getgraphic", _g_get_graphic);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshowMaskGraphic", _s_set_showMaskGraphic);
