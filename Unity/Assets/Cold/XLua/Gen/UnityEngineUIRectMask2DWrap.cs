...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIRectMask2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcanvasRect", _g_get_canvasRect);
        ...
        static int _m_AddClippable(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.AddClippable( 
                        _clippable );
        ...
        static int _m_RemoveClippable(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RemoveClippable( 
                        _clippable );
