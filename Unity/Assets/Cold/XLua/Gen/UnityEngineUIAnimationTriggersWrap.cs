...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIAnimationTriggersWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getnormalTrigger", _g_get_normalTrigger);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethighlightedTrigger", _g_get_highlightedTrigger);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpressedTrigger", _g_get_pressedTrigger);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectedTrigger", _g_get_selectedTrigger);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdisabledTrigger", _g_get_disabledTrigger);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setnormalTrigger", _s_set_normalTrigger);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethighlightedTrigger", _s_set_highlightedTrigger);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpressedTrigger", _s_set_pressedTrigger);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectedTrigger", _s_set_selectedTrigger);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdisabledTrigger", _s_set_disabledTrigger);
