...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIGTreeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrootNode", _g_get_rootNode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getindent", _g_get_indent);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getclickToExpand", _g_get_clickToExpand);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setclickToExpand", _s_set_clickToExpand);
        ...
        static int _m_UnselectNode(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.UnselectNode( 
                        _node );
