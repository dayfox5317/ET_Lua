...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIGTreeNodeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.GTreeNode);
			Utils.BeginObjectRegister(type, L, translator, 0, 27, 10, 4);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.GTreeNode _child = (FairyGUI.GTreeNode)translator.GetObject(L, 2, typeof(FairyGUI.GTreeNode));
                        ...
                        FairyGUI.GTreeNode gen_ret = gen_to_be_invoked.AddChild( 
                        _child );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _index = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        FairyGUI.GTreeNode gen_ret = gen_to_be_invoked.AddChildAt( 
                        _child, 
                        _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.GTreeNode _child = (FairyGUI.GTreeNode)translator.GetObject(L, 2, typeof(FairyGUI.GTreeNode));
                        ...
                        FairyGUI.GTreeNode gen_ret = gen_to_be_invoked.RemoveChild( 
                        _child );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.GTreeNode gen_ret = gen_to_be_invoked.RemoveChildAt( 
                        _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.GTreeNode gen_ret = gen_to_be_invoked.GetChildAt( 
                        _index );
                        translator.Push(L, gen_ret);
