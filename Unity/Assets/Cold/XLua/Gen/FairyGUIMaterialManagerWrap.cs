...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIMaterialManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfirstMaterialInFrame", _g_get_firstMaterialInFrame);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfirstMaterialInFrame", _s_set_firstMaterialInFrame);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "addonCreateNewMaterial", _e_add_onCreateNewMaterial);
						
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "removeonCreateNewMaterial", _e_remove_onCreateNewMaterial);
		    ...
		    try {
                ...
                
                {
                    System.Collections.Generic.IList<string> _keywords = (System.Collections.Generic.IList<string>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IList<string>));
                        ...
                        int gen_ret = gen_to_be_invoked.GetFlagsByKeywords( 
                        _keywords );
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		static int _e_add_onCreateNewMaterial(RealStatePtr L)
		{
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				int gen_param_count = LuaAPI.lua_gettop(L);
			FairyGUI.MaterialManager gen_to_be_invoked = (FairyGUI.MaterialManager)translator.FastGetCSObj(L, 1);
				System.Action<UnityEngine.Material> gen_delegate = translator.GetDelegate<System.Action<UnityEngine.Material>>(L, 2);
				if (gen_delegate == null) {
					return LuaAPI.luaL_error(L, "#2 need System.Action<UnityEngine.Material>!");
				}
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		static int _e_remove_onCreateNewMaterial(RealStatePtr L)
		{
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				int gen_param_count = LuaAPI.lua_gettop(L);
