...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIGButtonWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.GButton);
			Utils.BeginObjectRegister(type, L, translator, 0, 37, 17, 16);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrelatedPageId", _g_get_relatedPageId);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrelatedPageId", _s_set_relatedPageId);
