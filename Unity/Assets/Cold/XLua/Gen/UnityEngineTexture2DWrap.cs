...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineTexture2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.Texture2D);
			Utils.BeginObjectRegister(type, L, translator, 0, 31, 11, 2);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisReadable", _g_get_isReadable);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getvtOnly", _g_get_vtOnly);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstreamingMipmaps", _g_get_streamingMipmaps);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstreamingMipmapsPriority", _g_get_streamingMipmapsPriority);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrequestedMipmapLevel", _g_get_requestedMipmapLevel);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getminimumMipmapLevel", _g_get_minimumMipmapLevel);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcalculatedMipmapLevel", _g_get_calculatedMipmapLevel);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdesiredMipmapLevel", _g_get_desiredMipmapLevel);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getloadingMipmapLevel", _g_get_loadingMipmapLevel);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getloadedMipmapLevel", _g_get_loadedMipmapLevel);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrequestedMipmapLevel", _s_set_requestedMipmapLevel);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setminimumMipmapLevel", _s_set_minimumMipmapLevel);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getwhiteTexture", _g_get_whiteTexture);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getblackTexture", _g_get_blackTexture);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getredTexture", _g_get_redTexture);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getgrayTexture", _g_get_grayTexture);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getlinearGrayTexture", _g_get_linearGrayTexture);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getnormalTexture", _g_get_normalTexture);
        ...
        static int _m_UpdateExternalTexture(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.UpdateExternalTexture( 
                        _nativeTex );
		    ...
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Texture2D[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    int _padding = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        UnityEngine.Rect[] gen_ret = gen_to_be_invoked.PackTextures( 
                        _textures, 
                        _padding );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    System.IntPtr _nativeTex = LuaAPI.lua_touserdata(L, 6);
                        ...
                        UnityEngine.Texture2D gen_ret = UnityEngine.Texture2D.CreateExternalTexture( 
                        _width, 
                        _height, 
                        _format, 
                        _mipChain, 
		    ...
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    int _y = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        UnityEngine.Color gen_ret = gen_to_be_invoked.GetPixel( 
                        _x, 
                        _y );
		    ...
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _v = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Color gen_ret = gen_to_be_invoked.GetPixelBilinear( 
                        _u, 
                        _v );
                        translator.PushUnityEngineColor(L, gen_ret);
        ...
        static int _m_LoadRawTextureData(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TLIGHTUSERDATA == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.LoadRawTextureData( 
                        _data, 
                        _size );
		    ...
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    int _height = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        bool gen_ret = gen_to_be_invoked.Resize( 
                        _width, 
                        _height );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    System.Collections.Generic.List<UnityEngine.Rect> _results = (System.Collections.Generic.List<UnityEngine.Rect>)translator.GetObject(L, 4, typeof(System.Collections.Generic.List<UnityEngine.Rect>));
                        ...
                        bool gen_ret = UnityEngine.Texture2D.GenerateAtlas( 
                        _sizes, 
                        _padding, 
                        _atlasSize, 
                        _results );
