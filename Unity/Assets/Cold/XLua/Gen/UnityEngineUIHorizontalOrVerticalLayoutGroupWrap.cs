...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIHorizontalOrVerticalLayoutGroupWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getspacing", _g_get_spacing);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getchildForceExpandWidth", _g_get_childForceExpandWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getchildForceExpandHeight", _g_get_childForceExpandHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getchildControlWidth", _g_get_childControlWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getchildControlHeight", _g_get_childControlHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getchildScaleWidth", _g_get_childScaleWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getchildScaleHeight", _g_get_childScaleHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getreverseArrangement", _g_get_reverseArrangement);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setspacing", _s_set_spacing);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setchildForceExpandWidth", _s_set_childForceExpandWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setchildForceExpandHeight", _s_set_childForceExpandHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setchildControlWidth", _s_set_childControlWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setchildControlHeight", _s_set_childControlHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setchildScaleWidth", _s_set_childScaleWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setchildScaleHeight", _s_set_childScaleHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setreverseArrangement", _s_set_reverseArrangement);
