...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineEventSystemsBaseEventDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectedObject", _g_get_selectedObject);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectedObject", _s_set_selectedObject);
