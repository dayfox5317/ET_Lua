...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIUtilsUBBParserWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdefaultTagHandler", _g_get_defaultTagHandler);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethandlers", _g_get_handlers);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdefaultTagHandler", _s_set_defaultTagHandler);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethandlers", _s_set_handlers);
		    ...
		    try {
                ...
                
                {
                    bool _remove = LuaAPI.lua_toboolean(L, 2);
                        ...
                        string gen_ret = gen_to_be_invoked.GetTagText( 
                        _remove );
