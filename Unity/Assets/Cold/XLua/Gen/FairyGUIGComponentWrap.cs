...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIGComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.GComponent);
			Utils.BeginObjectRegister(type, L, translator, 0, 66, 19, 11);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getTransitions", _g_get_Transitions);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.GObject gen_ret = gen_to_be_invoked.GetChildByPath( 
                        _path );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetSnappingPosition(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.GetSnappingPosition( 
                        ref _xValue, 
                        ref _yValue );
        ...
        static int _m_GetSnappingPositionWithDir(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.GetSnappingPositionWithDir( 
                        ref _xValue, 
                        ref _yValue, 
                        _xDir, 
                        _yDir );
