...
namespace XLua.CSObjectWrap
{
    ...
    public partial class libxUpdaterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(libx.Updater);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					libx.Updater gen_ret = new libx.Updater();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to libx.Updater constructor!");
        ...
        static int _m_OnMessage(RealStatePtr L)
        {
		    try {
                ...
                libx.Updater gen_to_be_invoked = (libx.Updater)translator.FastGetCSObj(L, 1);
        ...
        static int _m_OnReachablityChanged(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.OnReachablityChanged( 
                        _reachability );
        ...
        static int _s_set_listener(RealStatePtr L)
        {
		    try {
                ...
                libx.Updater gen_to_be_invoked = (libx.Updater)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.listener = (libx.IUpdater)translator.GetObject(L, 2, typeof(libx.IUpdater));
