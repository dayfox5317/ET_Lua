...
namespace XLua.CSObjectWrap
{
    ...
    public partial class libxDownloadWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(libx.Download);
			Utils.BeginObjectRegister(type, L, translator, 0, 25, 11, 7);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettempPath", _g_get_tempPath);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcompleted", _g_get_completed);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfinished", _g_get_finished);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsavePath", _g_get_savePath);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsavePath", _s_set_savePath);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					libx.Download gen_ret = new libx.Download();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to libx.Download constructor!");
        ...
        static int _m_Clone(RealStatePtr L)
        {
		    try {
                ...
                libx.Download gen_to_be_invoked = (libx.Download)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Complete(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to libx.Download.Complete!");
        ...
        static int _s_set_completed(RealStatePtr L)
        {
		    try {
                ...
                libx.Download gen_to_be_invoked = (libx.Download)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.completed = translator.GetDelegate<System.Action<libx.Download>>(L, 2);
