...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIUIContentScalerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getscaleLevel", _g_get_scaleLevel);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setscaleFactor", _s_set_scaleFactor);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setscaleLevel", _s_set_scaleLevel);
