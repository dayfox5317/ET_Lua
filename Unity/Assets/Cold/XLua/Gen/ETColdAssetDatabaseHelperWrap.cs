...
namespace XLua.CSObjectWrap
{
    ...
    public partial class ETColdAssetDatabaseHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ETCold.AssetDatabaseHelper);
        ...
        {
            return LuaAPI.luaL_error(L, "ETCold.AssetDatabaseHelper does not have a constructor!");
        }
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _recursive = LuaAPI.lua_toboolean(L, 2);
                        ...
                        string[] gen_ret = ETCold.AssetDatabaseHelper.GetAssetBundleDependencies( 
                        _assetBundleName, 
                        _recursive );
		    ...
		    try {
                ...
                
                {
                    string _assetBundleName = LuaAPI.lua_tostring(L, 1);
                        ...
                        string[] gen_ret = ETCold.AssetDatabaseHelper.GetAssetPathsFromAssetBundle( 
                        _assetBundleName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _assetName = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.Object gen_ret = ETCold.AssetDatabaseHelper.LoadAssetAtPath( 
                        _assetName );
                        translator.Push(L, gen_ret);
