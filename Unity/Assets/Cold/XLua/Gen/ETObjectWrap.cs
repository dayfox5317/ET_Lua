...
namespace XLua.CSObjectWrap
{
    ...
    public partial class ETObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ET.Object);
        ...
        {
            return LuaAPI.luaL_error(L, "ET.Object does not have a constructor!");
        }
        ...
        static int _m_BeginInit(RealStatePtr L)
        {
		    try {
                ...
                ET.Object gen_to_be_invoked = (ET.Object)translator.FastGetCSObj(L, 1);
