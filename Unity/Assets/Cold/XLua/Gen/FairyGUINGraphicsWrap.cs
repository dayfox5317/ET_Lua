...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUINGraphicsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.NGraphics);
			Utils.BeginObjectRegister(type, L, translator, 0, 43, 18, 13);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmaterialPropertyBlock", _g_get_materialPropertyBlock);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "addmeshModifier", _e_add_meshModifier);
						
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "removemeshModifier", _e_remove_meshModifier);
        ...
        static int _m_ToggleKeyword(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ToggleKeyword( 
                        _keyword, 
                        _enabled );
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		static int _e_add_meshModifier(RealStatePtr L)
		{
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				int gen_param_count = LuaAPI.lua_gettop(L);
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		static int _e_remove_meshModifier(RealStatePtr L)
		{
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				int gen_param_count = LuaAPI.lua_gettop(L);
