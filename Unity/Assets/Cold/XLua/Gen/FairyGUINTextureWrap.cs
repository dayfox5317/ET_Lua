...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUINTextureWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.NTexture);
			Utils.BeginObjectRegister(type, L, translator, 0, 34, 13, 7);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setoriginalSize", _s_set_originalSize);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "addonSizeChanged", _e_add_onSizeChanged);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "addonRelease", _e_add_onRelease);
						
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "removeonSizeChanged", _e_remove_onSizeChanged);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "removeonRelease", _e_remove_onRelease);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addCustomDestroyMethod", _e_add_CustomDestroyMethod);
			
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removeCustomDestroyMethod", _e_remove_CustomDestroyMethod);
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		static int _e_add_onSizeChanged(RealStatePtr L)
		{
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				int gen_param_count = LuaAPI.lua_gettop(L);
			FairyGUI.NTexture gen_to_be_invoked = (FairyGUI.NTexture)translator.FastGetCSObj(L, 1);
				System.Action<FairyGUI.NTexture> gen_delegate = translator.GetDelegate<System.Action<FairyGUI.NTexture>>(L, 2);
				if (gen_delegate == null) {
					return LuaAPI.luaL_error(L, "#2 need System.Action<FairyGUI.NTexture>!");
				}
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		static int _e_add_onRelease(RealStatePtr L)
		{
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				int gen_param_count = LuaAPI.lua_gettop(L);
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		static int _e_remove_onSizeChanged(RealStatePtr L)
		{
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				int gen_param_count = LuaAPI.lua_gettop(L);
		...
		[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
		static int _e_remove_onRelease(RealStatePtr L)
		{
			try {
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_CustomDestroyMethod(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                System.Action<UnityEngine.Texture> gen_delegate = translator.GetDelegate<System.Action<UnityEngine.Texture>>(L, 1);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#1 need System.Action<UnityEngine.Texture>!");
                }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_CustomDestroyMethod(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
