...
namespace XLua.CSObjectWrap
{
    ...
    public partial class libxIUpdaterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(libx.IUpdater);
        ...
        {
            return LuaAPI.luaL_error(L, "libx.IUpdater does not have a constructor!");
        }
        ...
        static int _m_OnStart(RealStatePtr L)
        {
		    try {
                ...
                libx.IUpdater gen_to_be_invoked = (libx.IUpdater)translator.FastGetCSObj(L, 1);
