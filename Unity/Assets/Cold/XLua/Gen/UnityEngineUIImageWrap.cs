...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIImageWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.UI.Image);
			Utils.BeginObjectRegister(type, L, translator, 0, 43, 23, 13);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsprite", _g_get_sprite);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getoverrideSprite", _g_get_overrideSprite);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettype", _g_get_type);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpreserveAspect", _g_get_preserveAspect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfillCenter", _g_get_fillCenter);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getalphaHitTestMinimumThreshold", _g_get_alphaHitTestMinimumThreshold);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuseSpriteMesh", _g_get_useSpriteMesh);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmainTexture", _g_get_mainTexture);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethasBorder", _g_get_hasBorder);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpixelsPerUnitMultiplier", _g_get_pixelsPerUnitMultiplier);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsprite", _s_set_sprite);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setoverrideSprite", _s_set_overrideSprite);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settype", _s_set_type);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpreserveAspect", _s_set_preserveAspect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfillCenter", _s_set_fillCenter);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setalphaHitTestMinimumThreshold", _s_set_alphaHitTestMinimumThreshold);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setuseSpriteMesh", _s_set_useSpriteMesh);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpixelsPerUnitMultiplier", _s_set_pixelsPerUnitMultiplier);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getdefaultETC1GraphicMaterial", _g_get_defaultETC1GraphicMaterial);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Camera _eventCamera = (UnityEngine.Camera)translator.GetObject(L, 3, typeof(UnityEngine.Camera));
                        ...
                        bool gen_ret = gen_to_be_invoked.IsRaycastLocationValid( 
                        _screenPoint, 
                        _eventCamera );
