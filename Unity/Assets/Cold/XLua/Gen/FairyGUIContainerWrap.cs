...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIContainerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.Container);
			Utils.BeginObjectRegister(type, L, translator, 0, 50, 12, 11);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettabStopChildren", _g_get_tabStopChildren);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settabStopChildren", _s_set_tabStopChildren);
		    ...
		    try {
                ...
                
                {
                    bool _backward = LuaAPI.lua_toboolean(L, 2);
                        ...
                        System.Collections.Generic.IEnumerator<FairyGUI.DisplayObject> gen_ret = gen_to_be_invoked.GetDescendants( 
                        _backward );
