...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIGObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.GObject);
			Utils.BeginObjectRegister(type, L, translator, 0, 190, 103, 50);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getasLoader3D", _g_get_asLoader3D);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getasTree", _g_get_asTree);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettreeNode", _g_get_treeNode);
