...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUICanvasScalerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuiScaleMode", _g_get_uiScaleMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getreferencePixelsPerUnit", _g_get_referencePixelsPerUnit);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscaleFactor", _g_get_scaleFactor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getreferenceResolution", _g_get_referenceResolution);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscreenMatchMode", _g_get_screenMatchMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmatchWidthOrHeight", _g_get_matchWidthOrHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getphysicalUnit", _g_get_physicalUnit);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdynamicPixelsPerUnit", _g_get_dynamicPixelsPerUnit);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setuiScaleMode", _s_set_uiScaleMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setreferencePixelsPerUnit", _s_set_referencePixelsPerUnit);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setscaleFactor", _s_set_scaleFactor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setreferenceResolution", _s_set_referenceResolution);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setscreenMatchMode", _s_set_screenMatchMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmatchWidthOrHeight", _s_set_matchWidthOrHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setphysicalUnit", _s_set_physicalUnit);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdynamicPixelsPerUnit", _s_set_dynamicPixelsPerUnit);
