...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIDropdownWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.UI.Dropdown);
			Utils.BeginObjectRegister(type, L, translator, 0, 27, 9, 9);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettemplate", _g_get_template);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcaptionText", _g_get_captionText);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcaptionImage", _g_get_captionImage);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getitemText", _g_get_itemText);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getitemImage", _g_get_itemImage);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getalphaFadeSpeed", _g_get_alphaFadeSpeed);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getvalue", _g_get_value);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "settemplate", _s_set_template);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcaptionText", _s_set_captionText);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcaptionImage", _s_set_captionImage);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setitemText", _s_set_itemText);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setitemImage", _s_set_itemImage);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setalphaFadeSpeed", _s_set_alphaFadeSpeed);
        ...
        static int _m_SetValueWithoutNotify(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetValueWithoutNotify( 
                        _input );
