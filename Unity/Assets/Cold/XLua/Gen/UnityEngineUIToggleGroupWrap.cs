...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIToggleGroupWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getallowSwitchOff", _g_get_allowSwitchOff);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setallowSwitchOff", _s_set_allowSwitchOff);
        ...
        static int _m_NotifyToggleOn(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.UI.Toggle>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.NotifyToggleOn( 
                        _toggle, 
                        _sendCallback );
        ...
        static int _m_UnregisterToggle(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.UnregisterToggle( 
                        _toggle );
        ...
        static int _m_RegisterToggle(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RegisterToggle( 
                        _toggle );
