...
namespace XLua.CSObjectWrap
{
    ...
    public partial class libxBundleAsyncRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(libx.BundleAsyncRequest);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					libx.BundleAsyncRequest gen_ret = new libx.BundleAsyncRequest();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to libx.BundleAsyncRequest constructor!");
        ...
        static int _g_get_isDone(RealStatePtr L)
        {
		    try {
                ...
                libx.BundleAsyncRequest gen_to_be_invoked = (libx.BundleAsyncRequest)translator.FastGetCSObj(L, 1);
