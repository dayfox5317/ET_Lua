...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIUtilsByteBufferWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.Utils.ByteBuffer);
			Utils.BeginObjectRegister(type, L, translator, 0, 32, 7, 5);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbuffer", _s_set_buffer);
		    ...
		    try {
                ...
                
                {
                    int _cnt = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        string[] gen_ret = gen_to_be_invoked.ReadSArray( 
                        _cnt );
                        translator.Push(L, gen_ret);
        ...
        static int _m_ReadPath(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        System.Collections.Generic.List<FairyGUI.GPathPoint> gen_ret = gen_to_be_invoked.ReadPath(  );
                        translator.Push(L, gen_ret);
