...
namespace XLua.CSObjectWrap
{
    ...
    public partial class ETColdProcessHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ETCold.ProcessHelper);
        ...
        {
            return LuaAPI.luaL_error(L, "ETCold.ProcessHelper does not have a constructor!");
        }
        ...
        static int _m_Run_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _waitExit = LuaAPI.lua_toboolean(L, 4);
                        ...
                        System.Diagnostics.Process gen_ret = ETCold.ProcessHelper.Run( 
                        _exe, 
                        _arguments, 
                        _workingDirectory, 
                        _waitExit );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ETCold.ProcessHelper.Run!");
