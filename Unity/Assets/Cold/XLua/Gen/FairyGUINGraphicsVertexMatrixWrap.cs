...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUINGraphicsVertexMatrixWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcameraPos", _g_get_cameraPos);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmatrix", _g_get_matrix);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcameraPos", _s_set_cameraPos);
