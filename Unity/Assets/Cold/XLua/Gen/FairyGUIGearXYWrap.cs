...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIGearXYWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpositionsInPercent", _g_get_positionsInPercent);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpositionsInPercent", _s_set_positionsInPercent);
        ...
        static int _m_AddExtStatus(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.AddExtStatus( 
                        _pageId, 
                        _buffer );
