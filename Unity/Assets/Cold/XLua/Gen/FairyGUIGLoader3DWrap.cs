...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIGLoader3DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.GLoader3D);
			Utils.BeginObjectRegister(type, L, translator, 0, 43, 20, 19);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getloop", _g_get_loop);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getanimationName", _g_get_animationName);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getskinName", _g_get_skinName);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setloop", _s_set_loop);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setanimationName", _s_set_animationName);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setskinName", _s_set_skinName);
