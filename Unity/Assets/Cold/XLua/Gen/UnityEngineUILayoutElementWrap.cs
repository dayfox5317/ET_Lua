...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUILayoutElementWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setignoreLayout", _s_set_ignoreLayout);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpreferredWidth", _s_set_preferredWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpreferredHeight", _s_set_preferredHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setflexibleWidth", _s_set_flexibleWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setflexibleHeight", _s_set_flexibleHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlayoutPriority", _s_set_layoutPriority);
