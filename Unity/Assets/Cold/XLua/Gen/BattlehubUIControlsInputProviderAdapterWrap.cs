...
namespace XLua.CSObjectWrap
{
    ...
    public partial class BattlehubUIControlsInputProviderAdapterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Battlehub.UIControls.InputProviderAdapter);
			Utils.BeginObjectRegister(type, L, translator, 0, 25, 22, 1);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Battlehub.UIControls.InputProviderAdapter gen_ret = new Battlehub.UIControls.InputProviderAdapter();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Battlehub.UIControls.InputProviderAdapter constructor!");
        ...
        static int _m_IsMouseButtonDown(RealStatePtr L)
        {
		    try {
                ...
                Battlehub.UIControls.InputProviderAdapter gen_to_be_invoked = (Battlehub.UIControls.InputProviderAdapter)translator.FastGetCSObj(L, 1);
