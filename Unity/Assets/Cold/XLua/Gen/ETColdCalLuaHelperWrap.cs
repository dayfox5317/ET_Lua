...
namespace XLua.CSObjectWrap
{
    ...
    public partial class ETColdCalLuaHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ETCold.CalLuaHelper);
        ...
        {
            return LuaAPI.luaL_error(L, "ETCold.CalLuaHelper does not have a constructor!");
        }
        ...
        static int _m_ToJson_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<object>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _fieldName = LuaAPI.lua_tostring(L, 2);
                        ...
                        string gen_ret = ETCold.CalLuaHelper.ToJson( 
                        _obj, 
                        _fieldName );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ETCold.CalLuaHelper.ToJson!");
