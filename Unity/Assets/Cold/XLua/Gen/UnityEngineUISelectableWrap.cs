...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUISelectableWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getnavigation", _g_get_navigation);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettransition", _g_get_transition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcolors", _g_get_colors);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getspriteState", _g_get_spriteState);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getanimationTriggers", _g_get_animationTriggers);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettargetGraphic", _g_get_targetGraphic);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getinteractable", _g_get_interactable);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getimage", _g_get_image);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getanimator", _g_get_animator);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setnavigation", _s_set_navigation);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settransition", _s_set_transition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcolors", _s_set_colors);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setspriteState", _s_set_spriteState);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setanimationTriggers", _s_set_animationTriggers);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settargetGraphic", _s_set_targetGraphic);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setinteractable", _s_set_interactable);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setimage", _s_set_image);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getallSelectablesArray", _g_get_allSelectablesArray);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getallSelectableCount", _g_get_allSelectableCount);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.UI.Selectable[] _selectables = (UnityEngine.UI.Selectable[])translator.GetObject(L, 1, typeof(UnityEngine.UI.Selectable[]));
                        ...
                        int gen_ret = UnityEngine.UI.Selectable.AllSelectablesNoAlloc( 
                        _selectables );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _dir;translator.Get(L, 2, out _dir);
                        ...
                        UnityEngine.UI.Selectable gen_ret = gen_to_be_invoked.FindSelectable( 
                        _dir );
