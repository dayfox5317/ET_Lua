...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIGridLayoutGroupWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.UI.GridLayoutGroup);
			Utils.BeginObjectRegister(type, L, translator, 0, 16, 6, 6);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstartCorner", _g_get_startCorner);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstartAxis", _g_get_startAxis);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getconstraint", _g_get_constraint);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getconstraintCount", _g_get_constraintCount);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setstartCorner", _s_set_startCorner);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setstartAxis", _s_set_startAxis);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setconstraint", _s_set_constraint);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setconstraintCount", _s_set_constraintCount);
