...
namespace XLua.CSObjectWrap
{
    ...
    public partial class ETColdABPathHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetFGUIAtlasResPath", _m_GetFGUIAtlasResPath_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetFGUIAtlasResPath_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _fileName = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = ETCold.ABPathHelper.GetFGUIAtlasResPath( 
                        _fileName );
                        LuaAPI.lua_pushstring(L, gen_ret);
