...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIVertexHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcurrentIndexCount", _g_get_currentIndexCount);
        ...
        static int _m_PopulateUIVertex(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.PopulateUIVertex( 
                        ref _vertex, 
                        _i );
        ...
        static int _m_AddUIVertexQuad(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.AddUIVertexQuad( 
                        _verts );
        ...
        static int _m_AddUIVertexStream(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.AddUIVertexStream( 
                        _verts, 
                        _indices );
        ...
        static int _m_AddUIVertexTriangleStream(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.AddUIVertexTriangleStream( 
                        _verts );
        ...
        static int _m_GetUIVertexStream(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.GetUIVertexStream( 
                        _stream );
