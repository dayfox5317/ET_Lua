...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIInputTextFieldWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.InputTextField);
			Utils.BeginObjectRegister(type, L, translator, 0, 44, 21, 17);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectionBeginIndex", _g_get_selectionBeginIndex);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectionEndIndex", _g_get_selectionEndIndex);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcontextMenu", _g_get_contextMenu);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setonCopy", _s_set_onCopy);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setonPaste", _s_set_onPaste);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setcontextMenu", _s_set_contextMenu);
