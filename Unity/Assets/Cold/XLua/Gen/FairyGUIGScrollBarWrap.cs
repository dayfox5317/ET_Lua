...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIGScrollBarWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getgripDragging", _g_get_gripDragging);
        ...
        static int _m_SetDisplayPerc(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetDisplayPerc( 
                        _value );
        ...
        static int _m_setScrollPerc(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.setScrollPerc( 
                        _value );
