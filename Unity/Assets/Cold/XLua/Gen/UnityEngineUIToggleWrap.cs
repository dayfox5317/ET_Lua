...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineUIToggleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.UI.Toggle);
			Utils.BeginObjectRegister(type, L, translator, 0, 16, 5, 5);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettoggleTransition", _g_get_toggleTransition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getgraphic", _g_get_graphic);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settoggleTransition", _s_set_toggleTransition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setgraphic", _s_set_graphic);
        ...
        static int _m_SetIsOnWithoutNotify(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetIsOnWithoutNotify( 
                        _value );
