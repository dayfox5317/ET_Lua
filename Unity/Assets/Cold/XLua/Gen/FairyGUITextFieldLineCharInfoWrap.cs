...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUITextFieldLineCharInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbaseline", _g_get_baseline);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setwidth", _s_set_width);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setheight", _s_set_height);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbaseline", _s_set_baseline);
