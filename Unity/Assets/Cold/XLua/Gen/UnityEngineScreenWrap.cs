...
namespace XLua.CSObjectWrap
{
    ...
    public partial class UnityEngineScreenWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 52, 16, 9);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "SetResolution", _m_SetResolution_xlua_st_);
            
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getwidth", _g_get_width);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getheight", _g_get_height);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getdpi", _g_get_dpi);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcurrentResolution", _g_get_currentResolution);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getresolutions", _g_get_resolutions);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getfullScreen", _g_get_fullScreen);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getfullScreenMode", _g_get_fullScreenMode);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getsafeArea", _g_get_safeArea);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcutouts", _g_get_cutouts);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getautorotateToPortrait", _g_get_autorotateToPortrait);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getautorotateToPortraitUpsideDown", _g_get_autorotateToPortraitUpsideDown);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getautorotateToLandscapeLeft", _g_get_autorotateToLandscapeLeft);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getautorotateToLandscapeRight", _g_get_autorotateToLandscapeRight);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getorientation", _g_get_orientation);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getsleepTimeout", _g_get_sleepTimeout);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getbrightness", _g_get_brightness);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setfullScreen", _s_set_fullScreen);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setfullScreenMode", _s_set_fullScreenMode);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setautorotateToPortrait", _s_set_autorotateToPortrait);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setautorotateToPortraitUpsideDown", _s_set_autorotateToPortraitUpsideDown);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setautorotateToLandscapeLeft", _s_set_autorotateToLandscapeLeft);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setautorotateToLandscapeRight", _s_set_autorotateToLandscapeRight);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setorientation", _s_set_orientation);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setsleepTimeout", _s_set_sleepTimeout);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setbrightness", _s_set_brightness);
