...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUIGearDisplay2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcondition", _g_get_condition);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpages", _s_set_pages);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcondition", _s_set_condition);
		    ...
		    try {
                ...
                
                {
                    bool _connected = LuaAPI.lua_toboolean(L, 2);
                        ...
                        bool gen_ret = gen_to_be_invoked.Evaluate( 
                        _connected );
