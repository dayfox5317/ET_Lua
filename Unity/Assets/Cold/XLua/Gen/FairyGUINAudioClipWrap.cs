...
namespace XLua.CSObjectWrap
{
    ...
    public partial class FairyGUINAudioClipWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getCustomDestroyMethod", _g_get_CustomDestroyMethod);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setCustomDestroyMethod", _s_set_CustomDestroyMethod);
