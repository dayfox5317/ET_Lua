...
namespace XLua.CSObjectWrap
{
    ...
    public partial class BattlehubUIControlsTooltipControlTooltipWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Battlehub.UIControls.TooltipControl.Tooltip);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Battlehub.UIControls.TooltipControl.Tooltip gen_ret = new Battlehub.UIControls.TooltipControl.Tooltip();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Battlehub.UIControls.TooltipControl.Tooltip constructor!");
        ...
        static int _m_OnPointerEnter(RealStatePtr L)
        {
		    try {
                ...
                Battlehub.UIControls.TooltipControl.Tooltip gen_to_be_invoked = (Battlehub.UIControls.TooltipControl.Tooltip)translator.FastGetCSObj(L, 1);
