...
#endif
{
	public static class ByteHelper
	{
		...
		public static void WriteByteTo(this byte[] bytes, int offset, byte num)
		{
			bytes[offset] = num;
		}
		
		public static void WriteShortTo(this byte[] bytes, int offset, short num)
		{
			bytes[offset] = (byte)(num & 0xff);
			bytes[offset + 1] = (byte)((num & 0xff00) >> 8);
		}
		
		public static void WriteUShortTo(this byte[] bytes, int offset, ushort num)
		{
			bytes[offset] = (byte)(num & 0xff);
			bytes[offset + 1] = (byte)((num & 0xff00) >> 8);
		}
